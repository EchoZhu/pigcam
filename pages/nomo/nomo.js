...
Page({
  ...
  data: {
    ...
    canvasWidth: 0,
    canvasHeight: 0,
    quotes: "生活在阴沟里，依然有仰望星空的权利",
    filterhiddentag:false
  },
  //从拍照或者相册选择图片
  chose: function() {
    var that = this
  ...
  onLoad: function(options) {
    ...
    Product.get('5b7cc7f30e16543f310e58f3').then(res => {
      // success
      // console.info("data--" + res.data.contents[1])


      // this.setData({
      //   quotes: res.data.contents[0],
      // })
  ...
  drawFram: function(temtempFilePath) {
    ...
    ctx.fillText(quotes, greyrectX + 26, greyrectY + 25)
