...
(function (global, factory) {
  ...
  function cut() {
    ...
    self.setBoundStyle = function (ref) {
      if (ref === void 0) ref = {};
      var color = ref.color; if (color === void 0) color = '#ffe55c';
      var mask = ref.mask; if (mask === void 0) mask = 'rgba(0, 0, 0, 0)';
      var lineWidth = ref.lineWidth; if (lineWidth === void 0) lineWidth =2;

      var boundOption = [
        {
          start: { x: x - lineWidth, y: y + 50 - lineWidth },
          step1: { x: x - lineWidth, y: y - lineWidth },
          step2: { x: x + 50 - lineWidth, y: y - lineWidth }
        },
        {
          start: { x: x - lineWidth, y: y + height - 50 + lineWidth },
          step1: { x: x - lineWidth, y: y + height + lineWidth },
          step2: { x: x + 50 - lineWidth, y: y + height + lineWidth }
        },
        {
          start: { x: x + width - 50 + lineWidth, y: y - lineWidth },
          step1: { x: x + width + lineWidth, y: y - lineWidth },
          step2: { x: x + width + lineWidth, y: y + 50 - lineWidth }
        },
        {
          start: { x: x + width + lineWidth, y: y + height - 50 + lineWidth },
          step1: { x: x + width + lineWidth, y: y + height + lineWidth },
          step2: { x: x + width - 50 + lineWidth, y: y + height + lineWidth }
        }
      ];
